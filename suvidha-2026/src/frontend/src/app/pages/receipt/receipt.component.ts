...
@Component({
    ...
    template: `
    <div id="receipt" class="screen active justify-center items-center bg-slate-900 overflow-y-auto flex h-screen w-full flex-col">
        <div class="relative w-full max-w-[340px] flex flex-col items-center my-auto py-10">
            ...
            <!-- Paper -->
            <div class="bg-white w-[320px] p-8 text-center shadow-2xl relative z-10 paper-print overflow-hidden flex flex-col rounded-b-xl animate-[printScroll_2.5s_ease-out_forwards]">
                ...
                <div class="mt-8 pt-4 border-t-2 border-slate-900">
                     <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="mx-auto text-green-600 mb-2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
        ...
        <button (click)="home()" class="mt-10 px-10 py-4 bg-white text-slate-900 rounded-full font-bold hover:bg-blue-50 transition-colors shadow-[0_0_40px_rgba(255,255,255,0.2)] cursor-pointer">
            <span>Collect & Home</span>
        </button>
    </div>
  `
})
